...
### DogSystemEditor（犬系统编辑器）

* 将某个地图设置为城镇，某个地图作为附属城镇（进入附属城镇相当于进入城镇）
* 传送时目的地的坐标，目的地只能是世界地图

### VendorEditor（售货机商品编辑器）

不支持世界地图，世界地图也不支持使用售货机

* 售货机的商品、商品数量和所在地图，商品价格请使用 ```ItemsEditor```
...
### PlayerExperienceEditor（玩家经验值编辑器）
...
### TileSetEditor（图块集编辑器）

* 地图的图块和图块组合数据
* 地图的图块属性

### WorldMapEditor（世界地图编辑器）
