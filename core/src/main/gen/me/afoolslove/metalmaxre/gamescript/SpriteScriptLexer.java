...
public class SpriteScriptLexer extends Lexer {
    static {
    ...
    private static String[] makeRuleNames() {
        return new String[]{
                ...
                "T__126", "T__127", "DIRECTION", "LABEL", "LINE_COMMENT", "BLOCK_COMMENT",
                "TEXT", "STRING", "HEX", "BYTE", "BYTES", "NUMBER", "WS"
        };
    }
    ...
    public SpriteScriptLexer(CharStream input) {
        super(input);
